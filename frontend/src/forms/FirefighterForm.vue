    ...
    >
      <b-form ref="form" @submit="onSubmit" @reset="onReset">
        ...
        <b-form-group id="input-group-name" label="Imię: " label-for="name_id">
          <b-form-input id="name_id" v-model="form.name" required placeholder="Wpisz imię"></b-form-input>
        </b-form-group>

        <b-form-group id="input-group-age" label="Wiek: " label-for="age_id">
          <b-form-input id="age_id" v-model="form.age" required placeholder="Wpisz wiek"></b-form-input>
        </b-form-group>
